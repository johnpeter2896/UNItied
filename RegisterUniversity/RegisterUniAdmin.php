...
<div class="contact-title">
  <center><h2>Registration Administrator Form</h2></center>
</div>
<div class="register-form">
<form id="register-form"  action="registration.php" method="POST">
<label for="name">University Administrator Name(Require at least 2 characters)</label>
<div class="form-group has-error">
<input class="form-control" name="name" placeholder="University Administrator Name" type="text">
</div>
...
<input type="submit" class="form-control submit" value="Submit University Administrator">
  </form>
