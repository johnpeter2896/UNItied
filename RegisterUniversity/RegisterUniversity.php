...
<div class="contact-title">
  <center><h2>Register University Form</h2></center>
</div>
<br>
<div class="register-form">
<form id="register-form" action="register.php" method="POST" >
<label for="uniName">University Name(Require at least 2 characters)</label>
<div class="form-group has-error">
<input class="form-control" name="uniName" placeholder="University Name" type="text">
</div>
<br>
<br>
<br>
