  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="content_base">
        A one step convenience.
        <br>Register University page
...
<form id="register-form"  action="record.php" method="POST">
<label for="name">Programme Name</label>
<div class="form-group">
<input class="form-control" name="programmeName" placeholder="Programme Name" type="text">
</div>
<label for="description">Description of programme</label>
<div class="form-group">
<input name="description" type="text" class="form-control"  placeholder="Description"></input>
</div>
<label for="closingDate">Closing Date</label>
<div class="form-group">
<input name="closingDate" type="text" class="form-control"  placeholder="DD/MM/YYYY"></input>
</div>
<br>
<br>
<br>
...
<div class="footer">
  ...
  <div class="row">
    <div class="col-sm-3"><p>
      <a href="https://www.facebook.com/APDapac/">Facebook</a>
    <a href="https://www.facebook.com/APDapac/">
      <img src="https://geburtshausunna.de/wp-content/uploads/2018/02/logo-facebook.png" alt="" width="48" height="48"></a></p></div>
      <div class="col-sm-3"><p>
        <a href="https://twitter.com/apdnow">Twitter</a>
      <a href="https://twitter.com/apdnow">
        ...
        <a href="https://www.linkedin.com/authwall?trk=gf&trkInfo=AQFUiUJ-XSrYNgAAAWUM6XSY_r56EPwSxNLAKt30dtaO_8GFZzAuU_yN5fF-HKPAhe9TqYCbCHW3Xd_ERzm0OC66dRdg3u4Xnk7e6JYFtItW2B725VywbtIryfxb2JoD_0BXyQ4=&originalReferer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fcompany%2Fapdnow">
          ...
          <div class="col-sm-3"><p>
            <a href="https://www.instagram.com/apdaustralia/">Instagram</a>
          <a href="https://www.instagram.com/apdaustralia/">
